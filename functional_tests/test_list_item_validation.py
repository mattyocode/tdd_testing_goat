...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        # She starts typing text for the new item and the error disappears
    ...
    def test_error_messages_are_cleared_on_input(self):
        ...
        # User starts typing into the input box to clear the error
        self.get_item_input_box().send_keys('a')

        # User is pleased to see that the error message disappers
